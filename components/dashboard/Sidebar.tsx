...
type GroupName = "services" | "education" | "verification" | "account";
...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  function toggleGroup(group: GroupName) {
  ...
  function groupButton(label: string, group: GroupName, icon: React.ReactNode) {
            ...
            >
              ...
              >
                <GraduationCap
                  size={23}
                  strokeWidth={2.5}
                  className={isDark ? "text-indigo-700" : "text-white"}
                />
              ...
              <div className="min-w-0">
                ...
                <p
                  className={`
                    ...
                    ${isDark ? "text-indigo-200" : "text-indigo-500"}
                  `}
                >
                  Global Tech
                </p>
          ...
          >
            ...
            <span
              className={`
                ...
                ${isDark ? "bg-emerald-400" : "bg-gray-300"}
              `}
            >
              <span
                className={`
            ...
            {openGroups.account && (
              <div className="mt-1 space-y-1 pl-1">
                ...
                {navItem(
                  ...
                  "Transaction Status",
                  <SearchCheck size={17} strokeWidth={2.5} />,
                )}

                {navItem(
                  "/dashboard/transactions",
                  "Transactions",
                  <ReceiptText size={17} strokeWidth={2.5} />,
                )}
