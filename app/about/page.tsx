  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-gray-900 transition-colors dark:bg-gray-950 dark:text-gray-100">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-blue-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950">
          <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
            <div className="mx-auto max-w-3xl text-center">
              <p className="mb-4 font-semibold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">
                About Us
              </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-lg">
              <div className="absolute -inset-4 rounded-3xl bg-indigo-200/60 blur-2xl dark:bg-indigo-900/30" />

              <div className="relative overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
                <Image
                  src="/founder.jpg"
            ...
            <div>
              <p className="mb-3 font-semibold uppercase tracking-wide text-indigo-600 dark:text-indigo-400">
                Who We Are
              </p>
              ...
              <p className="mt-5 text-lg leading-8 text-gray-600 dark:text-gray-300">
                From buying data and airtime to paying electricity bills,
                renewing cable TV subscriptions, accessing NIN
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={service}
                className="flex items-start gap-3 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900"
              >
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-indigo-600 dark:text-indigo-400" />

                <p className="font-medium leading-6 text-gray-700 dark:text-gray-300">
                  {service}
                </p>
              </div>
            ))}
        ...
        <section className="bg-indigo-600 dark:bg-indigo-950">
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
            ...
            <div className="mx-auto mt-12 grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-2xl border border-transparent bg-white p-7 shadow-lg dark:border-gray-800 dark:bg-gray-900">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-100 dark:bg-indigo-950">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="grid items-center gap-12 rounded-3xl bg-gray-50 p-8 dark:bg-gray-900 sm:p-12 lg:grid-cols-[0.8fr_1.2fr] lg:p-16">
            {/* FOUNDER IMAGE */}

            <div className="flex justify-center">
              <div className="overflow-hidden rounded-3xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-800">
                <Image
                  src="/founder.jpg"
                  alt="Emmanuel, Founder of Brainfriend Global Tech"
                  width={450}
            ...
            <div>
              ...
              <p className="mt-1 font-bold text-gray-700 dark:text-gray-200">
                Fullstack Dev / Next.js / React / TypeScript / JavaScript
                / Tailwind CSS
              </p>
              ...
              <p className="mt-5 text-lg font-medium leading-8 text-gray-900 dark:text-white">
        ...
        <section className="bg-gray-50 dark:bg-gray-900">
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
            <div className="grid gap-8 md:grid-cols-2">
              <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-950 sm:p-10">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-blue-700 p-8 text-white shadow-xl dark:from-indigo-800 dark:to-blue-950 sm:p-12">
        ...
        <section className="border-t border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-950">
          <div className="mx-auto max-w-4xl px-6 py-20 text-center lg:px-8 lg:py-24">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3.5 font-semibold text-white transition hover:bg-indigo-700 sm:w-auto"
              >
                Create an Account
              ...
              <Link
                href="/contact"
                className="inline-flex w-full items-center justify-center rounded-xl border border-gray-300 bg-white px-6 py-3.5 font-semibold text-gray-700 transition hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 sm:w-auto"
              >
                Contact Us
              </Link>
            </div>
