    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-indigo-700 px-4 py-16 text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-indigo-100 sm:text-base">
            Have a question, need help with a transaction, or
            want to learn more about our services? We are here
            to help.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-5 lg:col-span-1">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 group-hover:text-indigo-600">
                  +2348143542037
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 group-hover:text-green-600">
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm sm:p-7 lg:col-span-2">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900">
                Send Us a Message
              </h2>
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl rounded-2xl bg-indigo-50 p-6 text-center sm:p-8">
